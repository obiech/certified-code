...
exports.ErrorCodeMap = exports.SUCCESS_WFP_CODE = void 0;
exports.SUCCESS_WFP_CODE = 1100;
exports.ErrorCodeMap = new Map([
    ...
    [
        1131,
        {
            ...
            messageForClient: 'Ваш платіж обробляється. Як тільки транзакція буде оброблена, Ви отримаєте повідомлення про стан платежу',
            whoCanHelp: 'psp\n\nБанк емітент карти',
        },
    ],
    [
        1132,
        {
            ...
            messageForClient: 'Вами створено замовлення .. на сайті ... Зробити оплату Ви можете протягом ХХ годин ХХ хвилин.',
            whoCanHelp: '',
        },
    ],
    [
    ...
    [
        1134,
        {
            ...
            messageForClient: 'Транзакція знаходиться на ручній перевірці співробітника моніторингу.',
            whoCanHelp: 'psp',
        },
    ],
    [
        1135,
        {
            ...
            messageForClient: "Не вдалося здійснити оплату.Будь ласка, спробуйте пізніше або зв'яжіться з торговцем на адресу котрого здійснюєте оплату",
            whoCanHelp: 'psp',
        },
    ],
    [
...
//# sourceMappingURL=code-mapping.js.map