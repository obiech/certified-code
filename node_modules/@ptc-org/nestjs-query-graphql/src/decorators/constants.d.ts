...
export declare const ID_FIELD_KEY = "nestjs-query:id-field";
...
export declare const CUSTOM_AUTHORIZER_KEY = "nestjs-query:custom-authorizer";
export declare const KEY_SET_KEY = "nestjs-query:key-set";
export declare const QUERY_OPTIONS_KEY = "nestjs-query:query-options";
